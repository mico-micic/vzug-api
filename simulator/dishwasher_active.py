...
def get_device_status():
    ...
    if COMMAND_GET_STATUS in cmd:
        return Response(get_response_from_file_raw("dishwasher_status_ok_resp.json"), mimetype='application/json')
...
def get_program():
    ...
    if COMMAND_GET_PROGRAM in cmd:
        return Response(get_response_from_file_raw("dishwasher_program_status_active.json"), mimetype='application/json')
